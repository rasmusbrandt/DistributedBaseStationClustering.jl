...
ax[:plot](transmit_powers_dBm, results_assignment_mean["Chen2014_kmeans"]["throughputs"][:,1], color=colours[:Chen2014_kmeans], linestyle="-", marker=markers[:Chen2014_kmeans], label=labels[:Chen2014_kmeans])
