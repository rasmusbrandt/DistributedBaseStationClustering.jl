...
ax1[:plot](transmit_powers_dBm, results_assignment_mean["CoalitionFormationClustering_Individual"]["utilities"][:,2], color=cf_col, linestyle="-", marker=".", label=L"Coalition formation ($b_k = 10$)")
ax1[:plot](transmit_powers_dBm, results_assignment_mean["CoalitionFormationClustering_Individual"]["utilities"][:,1], color=cf_col, linestyle="--", marker=".", label=L"Coalition formation ($b_k = 2$)")
...
ax3[:plot](transmit_powers_dBm, results_precoding_mean["CoalitionFormationClustering_Individual"]["weighted_logdet_rates_LB"][:,2], color=cf_col, linestyle="-", marker=".", label=L"Coalition formation ($b_k = 10$)")
ax3[:plot](transmit_powers_dBm, results_precoding_mean["CoalitionFormationClustering_Individual"]["weighted_logdet_rates_LB"][:,1], color=cf_col, linestyle="--", marker=".", label=L"Coalition formation ($b_k = 2$)")
