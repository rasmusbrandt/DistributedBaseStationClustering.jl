...
simulation_params["simulation_name"] = "raw-large_network-run3"
...
##########################################################################
# Generic plots
for p in (plot_params_longterm_sumrate, plot_params_longterm_num_sum_throughput_calculations, plot_params_longterm_no_clusters, plot_params_longterm_no_searches)
