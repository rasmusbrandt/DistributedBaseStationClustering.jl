...
ax1[:plot](transmit_powers_dBm, results_mean["CoalitionFormationClustering_Individual"]["utilities"][:,2], color=cf_col, linestyle="-", marker=".", label=L"Coalition formation ($b_k = 10$)")
ax1[:plot](transmit_powers_dBm, results_mean["CoalitionFormationClustering_Individual"]["utilities"][:,1], color=cf_col, linestyle="--", marker=".", label=L"Coalition formation ($b_k = 2$)")
...
ax2[:plot](transmit_powers_dBm, data["simulation_params"]["I"]./results_mean["CoalitionFormationClustering_Individual"]["no_clusters"][:,2], color=cf_col, linestyle="-", marker=".", label=L"Coalition formation ($b_k = 10$)")
ax2[:plot](transmit_powers_dBm, data["simulation_params"]["I"]./results_mean["CoalitionFormationClustering_Individual"]["no_clusters"][:,1], color=cf_col, linestyle="--", marker=".", label=L"Coalition formation ($b_k = 2$)")
