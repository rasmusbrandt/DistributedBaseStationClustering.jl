...
simulation_params["simulation_name"] = "num_coherence_symbols_$(start_time)"
network =
...
plot_params_instantaneous_sumrate["axes"][:xlabel] = "MS speed [km/h]"
plot_params_instantaneous_sumrate["xvals"] = vs_kmh
