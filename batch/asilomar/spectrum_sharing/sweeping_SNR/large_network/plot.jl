...
ax[:plot](transmit_powers_dBm, simulation_params["I"]./results_assignment_mean["Chen2014_kmeans"]["num_clusters"][:,1], markeredgewidth=1, color=colours[:Chen2014_kmeans], linestyle="-", marker=markers[:Chen2014_kmeans], label=labels[:Chen2014_kmeans])
ax[:plot](transmit_powers_dBm, simulation_params["I"]./results_assignment_mean["CoalitionFormationClustering_Individual"]["num_clusters"][:,2], color=colours[:CoalitionFormationClustering_Individual], linestyle="-", marker=markers[:CoalitionFormationClustering_Individual], label=L"Coalition formation ($b_k = 10$)")
ax[:plot](transmit_powers_dBm, simulation_params["I"]./results_assignment_mean["CoalitionFormationClustering_Individual"]["num_clusters"][:,1], color=colours[:CoalitionFormationClustering_Individual], linestyle="--", marker=markers[:CoalitionFormationClustering_Individual], label=L"Coalition formation ($b_k = 2$)")
...
ax[:plot](transmit_powers_dBm, (1/simulation_params["I"])*results_assignment_mean["CoalitionFormationClustering_Individual"]["num_searches"][:,2], color=colours[:CoalitionFormationClustering_Individual], linestyle="-", marker=markers[:CoalitionFormationClustering_Individual])
ax[:plot](transmit_powers_dBm, (1/simulation_params["I"])*results_assignment_mean["CoalitionFormationClustering_Individual"]["num_searches"][:,1], color=colours[:CoalitionFormationClustering_Individual], linestyle="--", marker=markers[:CoalitionFormationClustering_Individual])
